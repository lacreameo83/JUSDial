  ...
  return (
    <div>
      ...
      >
        ...
        ></div> */}
        <div className="relative z-50 flex flex-col gap-[4rem] max-2xl:gap-[6rem] ">
          <Nav />
          <Herosection />
        </div>
        <div
          ...
          className="absolute bottom-0 left-0 w-full bg-center   bg-cover h-[800px]   sm:h-[847px] bg-no-repeat   z-30  max-2xl:hidden "
        ></div>
