...
function FeaturedListing() {
  ...
  return (
    <div className="h-[4090px] sm:h-[2400px] xl:h-[1849px] w-full sm:w-[100%]  flex flex-col   items-center  bg-white  ">
      <div className="w-[373px] h-[102px] mt-[46px]  sm:mt-[106px] flex flex-col items-center justify-center ">
        <p className="font-[500] text-[18px] leading-[28px] w-[149px] h-[28px] PlusJakarta sm:font-[500] sm:text-[18px] sm:leading-[28px] text-center text-[#364436]">
          Featured Listing
        </p>
        <p className="w-[206px] h-[32px] font-[700] text-[24px] leading-[32px] sm:w-[473px] sm:h-[60px]  PlusJakarta sm:font-[600] sm:text-[48px] sm:leading-[60px] text-[#282828]  text-center ">
          Top Picks for You
        </p>
      </div>
      {/* The listing */}
      <div className="h-[3893.59px]  gap-[40px] bg-white   xl:h-[1454px] z-10 xl:gap-[60px] 2xl:h-[1454p] sm:mt-[100px] sm:gap-[18px]   w-[327px]   sm:w-[1184px] md:w-full xl:w-[1199px] 2xl:w-[1184px] mt-[20px] grid grid-cols-1 2xl:gap-[31px] md:grid-cols-2 place-items-center xl:grid-cols-3">
        {data.slice(0, 6).map((el) => (
          <div
            key={el.id}
            className="h-[615.6px]  w-[327px] gap-[24.48px] md:h-[704px]  xl:w-[400px] md:w-[374px] md:gap-0    2xl:w-[374px] flex flex-col justify-center xl:gap-[28px]"
          >
            {/* Image container */}
            <div
              style={{
              ...
              className=" group transition-all duration-500 z-10 h-[437.17px] w-[327px] sm:h-[500px] cardcontainer rounded-[30px]  bg-slate-500 sm:w-[374px] bg-center bg-cover bg-no-repeat   relative "
            >
              {/* <p className="  "> */}
            ...
            <div className="h-[176px]  w-[327px] gap-[2px] sm:h-[176px] flex flex-col  sm:gap-2 ">
              ...
              <div>
                ...
                <div className="w-[327px]   h-[63px] font-[400] text-[13.99px] leading-[20.8px] PlusJakarta  sm:w-[374px] text-justify sm:h-[72px]  sm:text-[16px] sm:leading-[24px]">
                  {el.values}
                </div>
              </div>
            </div>
